...
export default function TermsConditions() {
  return (
    <main className="flex flex-col">
      <BreadCrumb page={"/"} title={"Terms and Conditions"} />
        <p>Business Terms and Conditions
​​​​​1 Definition
...
2.3 The Customer shall pay for the invoice when due without deduction or deferment on account of any claim, counterclaim or set-off. The Company is entitled to impose interest on the overdue sum of money without prejudice to other rights or remedies it may have.
...
3.3.1 The Customer must explicitly inform the Company about the nature of the Goods, including but not limited to Dangerous Goods, in their instruction to the Company. “Dangerous Goods” includes goods that are or may become dangerous, inflammable, radio-active, likely to damage nature or environment; liable to taint or affect other goods or goods likely to harbour or encourage vermin or other pests or otherwise under local laws rules and regulations as identified as dangerous.
...
5.1 The Company and the Customer shall upon demand defend, hold harmless and indemnify each other from and against all claims, lawsuits, demands, liability, costs, fines, penalties, loss, damages and expenses caused by, arising out of, or connected with any injury to or death of persons, or damage to property, arising out of the intentional acts or out of the negligent performance of the Services, including attorney’s fees and other reasonable costs of defence. To the extent any loss in question arises from the joint negligence of the Customer and the Company, liability as between the Parties shall be determined on the basis of comparative negligence.
...
9.1 In the Event of Force Majeure, both the Company and the Customer shall be excused from performing or delay in performing the Services and obligations contained herein.
...
9.3 “Event of Force Majeure” as defined herein means fire, flood, explosion, typhoon, earthquake, sandstorm, windstorm, infection disease, epidemic, pandemic, riots, calamities, strikes, lockout, labour shortage or dispute, war, other acts of God, acts or requests of government, accident, change of regulations or rules or law or government policy which renders a Party incapable of performing any of its obligations hereunder or resulting in an inability to obtain material, power, equipment or transportation from the occurrence of such circumstances, computer virus, the failure of the other Party, or any other unforeseen cause beyond the control of such Party.
