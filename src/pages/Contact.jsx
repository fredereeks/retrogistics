      ...
      <section className="smart relative px-5 py-20 bg-white">
        <div className="container max-w-[1024px] mx-auto grid grid-cols-1 md:grid-cols-2 md:items-stretch gap-6">
          ...
          <div className="flex flex-col gap-6 py-5 relative z-10">
            <form onSubmit={handleSubmit} id="contact-form" className="flex flex-col bg-gray-100/50 pb-4">
          ...
          <div className="flex flex-col md:justify-center gap-4 sm:mx-auto sm:gap-8 md:gap-10 relative">
            <h2 className="text-slate-800 text-2xl sm:text-3xl lg:text-4xl font-medium max-w-lg">We have a team of <span className="text-orange-500">Shipping Experts</span> committed to helping you grow!</h2>
            <p className="text-slate-500 text-sm md:text-base leading-loose max-w-lg">Whether you are an established business or just getting started, you will have access to free, comprehensive onboarding support</p>
